    ...
    const scheme = {
        authenticate: async (request, h) => {
            ...
            if (parts[0].toLowerCase() !== settings.tokenType.toLowerCase()) {
                throw settings.unauthorizedFunc(null, settings.tokenType);
            }
            ...
            if (!isValid) {
                ...
                return h.unauthenticated(settings.unauthorizedFunc(message, settings.tokenType), { credentials, artifacts });
            }
